...
class ProgTimer():
    ...
    def __str__(self):
        print("This instance contain the function {}".format(str(self.func)))
...
p1RL10 = peak1(RL10)
print('[10] Peak Finder 1 found peak: {} in {} steps'.format(p1RL10[0],p1RL10[1]))




# ### Time Tests
p1Timer = ProgTimer(peak1)
if mstt:
    print('\nCalculating rum_time of Peak Finder 1 in ms.\nThis may take a while...')
    p1WC10000T = p1Timer.progTimer(WC10000)
    p1WC1000T = p1Timer.progTimer(WC1000)
    p1WC100T = p1Timer.progTimer(WC100)
    p1WC10T = p1Timer.progTimer(WC10)
    print('Done\n')
...
p2aRL10 = peak2a(RL10)
print('[10] Peak Finder 2a found peak: {} in {} steps'.format(p2aRL10[0],p2aRL10[1]))



# ### Time Tests

p2aTimer = ProgTimer(peak2a)
if mstt:
    print('\nCalculating rum_time of Peak Finder 2a in ms.\nThis may take a while...')
    p2aWC10000T = p2aTimer.progTimer(WC10000)
    p2aWC1000T = p2aTimer.progTimer(WC1000)
    p2aWC100T = p2aTimer.progTimer(WC100)
    p2aWC10T = p2aTimer.progTimer(WC10)
    print('Done\n')
...
p2bRL10 = peak2b(WC10)
print('[10] Peak Finder 2b found peak: {} in {} steps'.format(p2bRL10[0],p2bRL10[1]))


# ### Time Tests

p2bTimer = ProgTimer(peak2b)
if mstt:
    print('\nCalculating rum_time of Peak Finder 2b in ms.\nThis may take a while...')
    p2bWC10000T = p2bTimer.progTimer(WC10000)
    p2bWC1000T = p2bTimer.progTimer(WC1000)
    p2bWC100T = p2bTimer.progTimer(WC100)
    p2bWC10T = p2bTimer.progTimer(WC10)
    print('Done\n')
...
p3RL10 = peak3(RL10)
print('[10] Peak Finder 3 found peak: {} in {} steps'.format(p3RL10[0],p3RL10[1]))


# ### Time Tests

p3Timer = ProgTimer(peak3)
if mstt:
    print('\nCalculating rum_time of Peak Finder 3 in ms.\nThis may take a while...')
    p3WC10000T = p3Timer.progTimer(WC10000)
    p3WC1000T = p3Timer.progTimer(WC1000)
    p3WC100T = p3Timer.progTimer(WC100)
    p3WC10T = p3Timer.progTimer(WC10)
    print('Done\n')
...
if mstt:
    ...
    data_1D_RT = {'algorithm':['Peak Finder 1','Peak Finder 1','Peak Finder 1','Peak Finder 1',
                          'Peak Finder 2a','Peak Finder 2a', 'Peak Finder 2a', 'Peak Finder 2a',
                          'Peak Finder 2b','Peak Finder 2b', 'Peak Finder 2b', 'Peak Finder 2b',
                          'Peak Finder 3','Peak Finder 3', 'Peak Finder 3', 'Peak Finder 3',],
           'n':['10000','1000', '100', '10',  '10000','1000', '100', '10', 
                '10000','1000', '100', '10', '10000','1000', '100', '10'],
           'run_time':[p1WC10000T,p1WC1000T, p1WC100T, p1WC10T, 
                       p2aWC10000T,p2aWC1000T, p2aWC100T, p2aWC10T, 
                       p2bWC10000T,p2bWC1000T, p2bWC100T, p2bWC10T, 
                       p3WC10000T,p3WC1000T, p3WC100T, p3WC10T]}
...
# #### Time Tests
p2D1Timer = ProgTimer(peak2D1)
if mstt:
    
    print('\nCalculating rum_time for 2D Peaak Finder 1 in ms.\nThis may take a while...')
    twoByP1T = p2D1Timer.progTimer(twoBy)
    threeByP1T = p2D1Timer.progTimer(threeBy)
    fourByP1T = p2D1Timer.progTimer(fourBy)
    fiveByP1T = p2D1Timer.progTimer(fiveBy)
    sixByP1T = p2D1Timer.progTimer(sixBy)
    sevenByP1T = p2D1Timer.progTimer(sevenBy)
    eightByP1T = p2D1Timer.progTimer(eightBy)
    nineByP1T = p2D1Timer.progTimer(nineBy)
    print('Done\n')
...
# #### Time Tests
p2D2Timer = ProgTimer(peak2D2)
if mstt:
    
    print('\nCalculating rum_time for 2D Peaak Finder 2 in ms.\nThis may take a while...')
    twoByP2T = p2D2Timer.progTimer(twoBy)
    threeByP2T = p2D2Timer.progTimer(threeBy)
    fourByP2T = p2D2Timer.progTimer(fourBy)
    fiveByP2T = p2D2Timer.progTimer(fiveBy)
    sixByP2T = p2D2Timer.progTimer(sixBy)
    sevenByP2T = p2D2Timer.progTimer(sevenBy)
    eightByP2T = p2D2Timer.progTimer(eightBy)
    nineByP2T = p2D2Timer.progTimer(nineBy)
    print('Done\n')
